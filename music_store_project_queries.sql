...
-- will be declared the best customer. Write a query that returns 3 person 
...
-- Rock Music listeners. Return your list ordered alphabetically by 
...
-- We determine the most popular genre as the genre with the 
-- highest amount of purchases. Write a query that returns each country 
-- along with the top Genre. For countries where the maximum number of purchases
...
-- the most on music for each country. Write a query that 
-- returns the country along with the top customer and 
-- how much they spent. For countries where the top amount spent 
